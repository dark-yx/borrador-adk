#!/usr/bin/env python3
"""
Script para configurar Google Drive API para LegisLink Pro
"""
...
def setup_drive_api():
    ...
    try:
        ...
        config = {
            ...
            "service_account_email": "legislink-service@legislink-pro.iam.gserviceaccount.com"
        }
