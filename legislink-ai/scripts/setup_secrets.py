#!/usr/bin/env python3
"""
Script para configurar Secret Manager para LegisLink AI
"""
...
def setup_secrets():
    ...
    secrets = [
        {
            "secret_id": "legislink-ai-gemini-key",
            "description": "API key para Gemini AI"
        },
        {
            "secret_id": "legislink-ai-db-password",
            "description": "Contraseña de la base de datos MySQL"
        },
        {
            "secret_id": "legislink-ai-db-host",
            "description": "Host de la base de datos Cloud SQL"
        },
        {
            "secret_id": "legislink-ai-db-name",
            "description": "Nombre de la base de datos"
        },
        {
            "secret_id": "legislink-ai-db-user",
            "description": "Usuario de la base de datos"
        },
        {
            "secret_id": "legislink-ai-drive-folder",
